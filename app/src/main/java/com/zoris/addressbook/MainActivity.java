...
public class MainActivity extends AppCompatActivity
   ...
   //private EditText userName = (EditText) findViewById(R.id.editTextUsername);
   //userName = (EditText) findViewById(R.id.editTextUsername);
  // public static String USER_ID = DatabaseDescription.COLUMN_USER_ID;
  // static Bundle bundle = getIntent().getExtras();
   //public static String USER_ID = bundle.getString("user_id");
